...
btnClear = Button(calc, text="C", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                  bg="blue", command=added_value.Clear_Entry).grid(row=1, column=0, pady=1)

# the 'CE' Button
btnClearAll = Button(calc, text="CE", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                     bg="blue", command=added_value.all_clear_entry).grid(row=1, column=1, pady=1)

# the '√ ' button
btnSqrt = Button(calc, text="√ ", width=6, height=2, font=('arial', 20, 'bold'),
                 bd=4, bg="blue", command=added_value.squared).grid(row=1, column=2, pady=1)

# the '+' Button
btnAdd = Button(calc, text="+", width=6, height=5, font=('arial', 20, 'bold'), bd=4, bg="blue",
...
btnSub = Button(calc, text="-", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                bg="blue", command=lambda: added_value.operation("sub")).grid(row=3, column=3, pady=1)

# the 'x' Button
btnMult = Button(calc, text="x", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                 bg="blue", command=lambda: added_value.operation("multi")).grid(row=1, column=3, pady=1)

# the '÷' Button
btnDiv = Button(calc, text="÷", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                bg="blue", command=lambda: added_value.operation("divide")).grid(row=2, column=3, pady=1)
...
btnDot = Button(calc, text=".", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                bg="blue", command=lambda: added_value.numberEnter(".")).grid(row=5, column=1, pady=1)
...
btnPi = Button(calc, text="𝝿", width=6, height=2, font=('arial', 20, 'bold'),
               bd=4, bg="blue", command=added_value.pi).grid(row=1, column=4, pady=1)

# the '2𝝿' Button
btn2Pi = Button(calc, text="2𝝿", width=6, height=2, font=('arial', 20, 'bold'),
                bd=4, bg="blue", command=added_value.tau).grid(row=2, column=4, pady=1)

# the 'Cos' Button
btnCos = Button(calc, text="cos", width=6, height=2, font=('arial', 20, 'bold'),
                bd=4, bg="blue", command=added_value.cos).grid(row=1, column=5, pady=1)

# the 'sec' Button
btnsec = Button(calc, text="sec", width=6, height=2, font=('arial', 20, 'bold'),
                bd=4, bg="blue", command=added_value.sec).grid(row=2, column=5, pady=1)

# the 'sin' Button
btnSin = Button(calc, text="sin", width=6, height=2, font=('arial', 20, 'bold'),
                bd=4, bg="blue", command=added_value.sin).grid(row=1, column=7, pady=1)

# the 'Cosec' Button
btnCosec = Button(calc, text="cosec", width=6, height=2, font=('arial', 20, 'bold'),
                  bd=4, bg="blue", command=added_value.cosec).grid(row=2, column=7, pady=1)

# the 'Tan' Button
btnTan = Button(calc, text="tan", width=6, height=2, font=('arial', 20, 'bold'),
                bd=4, bg="blue", command=added_value.tan).grid(row=1, column=6, pady=1)

# the 'Cot' Button
btnCot = Button(calc, text="cot", width=6, height=2, font=('arial', 20, 'bold'),
                bd=4, bg="blue", command=added_value.cot).grid(row=2, column=6, pady=1)

# Basic Logarithmic functions

# the 'Log' Button
btnLog = Button(calc, text="log", width=6, height=2, font=('arial', 20, 'bold'),
                bd=4, bg="blue", command=added_value.log).grid(row=3, column=4, pady=1)

# the 'Exp' Button
btnExp = Button(calc, text="Exp", width=6, height=2, font=('arial', 20, 'bold'),
                bd=4, bg="blue", command=added_value.exp).grid(row=3, column=5, pady=1)

# the 'Mod' Button
btnMod = Button(calc, text="Mod", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                bg="blue", command=lambda: added_value.operation("mod")).grid(row=3, column=6, pady=1)

# the 'e' Button
btnE = Button(calc, text="e", width=6, height=2, font=('arial', 20, 'bold'),
              bd=4, bg="blue", command=added_value.e).grid(row=3, column=7, pady=1)

# the 'Log2' Button
btnLog2 = Button(calc, text="log2", width=6, height=2, font=('arial', 20, 'bold'),
                 bd=4, bg="blue", command=added_value.log2).grid(row=4, column=4, pady=1)

# the 'deg' Button
btnDeg = Button(calc, text="deg", width=6, height=2, font=('arial', 20, 'bold'),
                bd=4, bg="blue", command=added_value.deg).grid(row=4, column=5, pady=1)

# the 'cosh' Button
btncosh = Button(calc, text="cosh", width=6, height=2, font=('arial', 20, 'bold'),
                 bd=4, bg="blue", command=added_value.cosh).grid(row=4, column=6, pady=1)

# the 'sinh' Button
btnsinh = Button(calc, text="sinh", width=6, height=2, font=('arial', 20, 'bold'),
                 bd=4, bg="blue", command=added_value.sinh).grid(row=4, column=7, pady=1)

# the 'Log10' Button
btnLog10 = Button(calc, text="log10", width=6, height=2, font=('arial', 20, 'bold'),
                  bd=4, bg="blue", command=added_value.log10).grid(row=5, column=4, pady=1)

# the 'Log1p' Button
btnLog1p = Button(calc, text="log1p", width=6, height=2, font=('arial', 20, 'bold'),
                  bd=4, bg="blue", command=added_value.log1p).grid(row=5, column=5, pady=1)

# the 'Expm1' Button
btnExpml = Button(calc, text="expm1", width=6, height=2, font=('arial', 20, 'bold'),
                  bd=4, bg="blue", command=added_value.expml).grid(row=5, column=6, pady=1)

# the 'lgamma' Button
btnlgamma = Button(calc, text="lgamma", width=6, height=2, font=('arial', 20, 'bold'),
                   bd=4, bg="blue", command=added_value.lgamma).grid(row=5, column=7, pady=1)
